        ...
        <main>
          <div className="flex flex-col">
            ...
            <div className="flex flex-col justify-center items-center p-12 md:p-24 lg:px-52 xl:px-72">
              ...
              <button className="text-xl text-white hover:text-black font-semibold bg-black hover:bg-white border-2 border-black py-4 px-7 rounded-xl">
                Learn more
              </button>
            </div>
